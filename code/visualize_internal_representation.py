...
if __name__ == "__main__":
	...
	parser.add_argument('-dr','--dimensionality-reduction-method',type=str,required=False,
		default='pca',dest='dim_reduction_method',help='Dimensionality reduction method')
	...
	model.visualize_image_representation(args.input_data_path,args.metadata_path,
		args.output_data_path,args.dim_reduction_method,args.num_examples_per_class)
